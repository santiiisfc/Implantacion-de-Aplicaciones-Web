...
<?php if (!isset($_POST["dni"])) : ?>
    ...
    <div style='margin: 65 100 100 150;float:left;'>
      ...
      <table border="0">
        <tr>
          <td>DNI:  </td>
          <td><input type="text" name="dni" maxlength="13" size="10" required></td>
        </tr>
        <tr>
          <td>Nombre:  </td>
          <td><input type="text" name="nombre" maxlength="14" size="10" required></td>
        </tr>
        <tr>
          <td>Apellidos:  </td>
          <td><input type="text" name="apellidos" maxlength="14" size="10" required></td>
        </tr>
        <tr>
          <td>Direccion:  </td>
          <td><input type="text" name="direccion" maxlength="14" size="10" required></td>
        </tr>
        <tr>
          <td>Telefono:  </td>
          <td><input type="text" name="telefono" maxlength="14" size="10" required></td>
        </tr>
        <tr>
          <td>Correo:  </td>
          <td><input type="text" name="correo" maxlength="14" size="10" required></td>
        </tr>
        <tr>
          <td>Curso:  </td>
